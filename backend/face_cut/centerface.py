...
class CenterFace(object):
    def __init__(self, landmarks=True):
        ...
        if self.landmarks:
            self.net = cv2.dnn.readNetFromONNX('/var/www/backend/face_cut/models/onnx/centerface.onnx')
        else:
            self.net = cv2.dnn.readNetFromONNX('/var/www/backend/face_cut/onnx/cface.1k.onnx')
